...
books=[{'bookname':'Sports','isbn':890345,'quantity':11,'cost':1200},{'bookname':'Wings of Fire','isbn':3678,'quantity':10,'cost':750},{'bookname':'Autobiography','isbn':1717,'quantity':20,'cost':200},{'bookname':'Way to Success','isbn':9090,'quantity':30,'cost':300}]
users=[]
book_borrow=[]
view_my_books=[]
cart_list=[]
